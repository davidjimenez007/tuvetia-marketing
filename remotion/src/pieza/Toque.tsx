/**
 * Pieza · el toque en móvil (§4.1): sin flecha, un círculo de contacto que aparece y se desvanece
 * en 10 frames. Se posiciona por ref, en px de app, contra el DOM de ESTE frame. Si el blanco no
 * está, revienta con el nombre de la toma (sin repuesto x/y).
 */
...
export function estadoToqueEn<Ctx>(
  frame: number,
  doc: Document,
