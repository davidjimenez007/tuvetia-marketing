/**
 * ExplainerRAG · tecleo por frame (§2.4). La pregunta se corta por caracteres (el textarea no
 * pasa por bloquesRicos); la respuesta se corta por palabras y sólo en cortes seguros: nunca
 * un `[1]` a medias, nunca un `**` o un `*` sin cerrar, nunca un marcador de viñeta suelto
 * (bloquesRicos exige espacio después del marcador y pintaría un guion como párrafo).
